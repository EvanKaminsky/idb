            ...
            <div id="names" className="container">
                <div className="row">
                    ...
                    <div className="col-md-2">
                        <h3>Rohit</h3>
                        <img className="img-responsive" src="../../static/assets/faces/rohit.jpg" />
                    ...
                    <div className = "col-md-2">
                        <h3>Mica</h3>
                        <img className="img-responsive" src="../../static/assets/faces/mica.jpg" />
                    ...
                    <div className = "col-md-2">
                        <h3>Abhi</h3>
                        <img className="img-responsive" src="../../static/assets/faces/abhi.jpg" />
                    ...
                    <div className = "col-md-2">
                        <h3>Evan</h3>
                        <img className="img-responsive" src="../../static/assets/faces/evan.jpg" />
                    ...
                    <div className="col-md-2">
                        <h3>Balazs</h3>
                        <img className="img-responsive" src="../../static/assets/faces/balazs.jpg" />
